    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProjectDepartmentId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DepartmentId = table.Column<int>(type: "int", nullable: false),
                    ProjectId = table.Column<int>(type: "int", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SprintListId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SprintId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SprintLists", x => x.SprintListId);
                    table.ForeignKey(
                        name: "FK_SprintLists_Sprints_SprintId",
                        column: x => x.SprintId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CardPriority = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CardDateCreated = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CardDateDue = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CardPercentageCompleted = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Cards", x => x.CardId);
                    table.ForeignKey(
                        name: "FK_Cards_SprintLists_SprintListId",
                        column: x => x.SprintListId,
                        principalTable: "SprintLists",
                        principalColumn: "SprintListId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CardMemberId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CardId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CardMembers", x => x.CardMemberId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubTaskDueDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "CardCommentVotes",
                columns: table => new
                {
                    CardCommentVoteId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CardCommentId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CardCommentVotes", x => x.CardCommentVoteId);
                    table.ForeignKey(
                        name: "FK_CardCommentVotes_CardComments_CardCommentId",
                        column: x => x.CardCommentId,
                        principalTable: "CardComments",
                        principalColumn: "CardCommentId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CardCommentVotes_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SubTaskAssigneeId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SubTaskId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubTaskAssignees", x => x.SubTaskAssigneeId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CardCommentVotes_CardCommentId",
                table: "CardCommentVotes",
                column: "CardCommentId");

            migrationBuilder.CreateIndex(
                name: "IX_CardCommentVotes_UserId",
                table: "CardCommentVotes",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubTaskAssignees_SubTaskId",
